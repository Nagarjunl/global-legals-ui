...
const SECDetails = ({ data, baseUrl }) => {
    return (
        <div className="container mx-auto">
            ...
            <div className="mt-10">
                <h3 className="mb-4 font-medium leading-[34.32px] text-[24px] mt-10  sm:col-span-6">
            ...
            <div className="mt-10">
                <h3 className="mb-4 sm:col-span-6 font-medium leading-[34.32px] text-[24px]">
