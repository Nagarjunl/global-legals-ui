    ...
    <>
      <div className="bg-green-800 ">
        <div className=" ">
          ...
          <div className="">
            <div className="container py-19 pb-0   px-12 mx-auto flex flex-wrap flex-col md:flex-row items-center">
              <div className="flex flex-col w-full xl:w-2/5 justify-start lg:items-start overflow-y-hidden mb-0  sm:mb-0">
      ...
      <div className="mx-auto py-1 sm:py-12  container px-4 sm:px-6 lg:px-8">
        <div className="container my-12  mx-auto px-4 md:px-12">
          <h1 className="text-black  font-circular-std md:text-4xl lg:text-4xl max-lg:text-4xl">
            Services we Offer
          </h1>
          <div className="flex flex-wrap -mx-1 lg:-mx-4 justify-center md:justify-center lg:justify-center">
            <div className="grid place-items-center rounded-lg p-6 lg:overflow-visible md:w-1/2 lg:my-4 lg:px-4 lg:w-1/4">
              <ServiceCard
                image={CardOne}
      ...
      <div className="bg-lime-50">
        <div className="mx-auto py-0 sm:py-12  px-4 sm:px-6 lg:px-8 bg-lime-50 container">
          <div className="grid m-8 grid-cols-1 gap-1 md:gap-0 text-start sm:text-start lg:text-start sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 ">
            ...
            <div className="hidden md:grid lg:grid justify-center items-end">
      ...
      <div>
        <div className="mx-auto py-5 sm:py-12 md:p-22  container px-4 sm:px-6 lg:px-8">
          <div className=" grid  grid-cols-1 gap-4   p-5 sm:p-10 md:p-14 text-center sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
            ...
            <div className="  text-start md:text-start lg:text-start  justify-center p-5 pt-2 sm:pt-12 md:p-16 pl-20 md:pl-10">
              <blockquote className="sm:p-0 text-4xl font-serif italic">
                “When you want to create a business bigger than yourself, you
                need a lot of help. thats what Global legals does”
              </blockquote>
              <figure className="flex items-start mt-6 space-x-3 rtl:space-x-reverse">
                <cite className=" text-lg text-gray-500 dark:text-gray-400 font-mono">
      ...
      <div className="bg-green-50">
        <div className="mx-auto py-5 sm:py-12 md:p-22  container px-4 sm:px-6 lg:px-8 bg-green-50">
          ...
          <div className=" grid  grid-cols-1 gap-4 p-5 sm:p-10 md:p-14 lg:p-14  sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2">
            <ServiceCardTwo
              image={RoadMapImg1}
              content={"Explore the legal Labyrinth"}
              contentBold={"Finding the Right Lawyer for your Needs"}
            />
            <ServiceCardTwo
              image={RoadMapImg1}
              content={"From Incarceration to Liberation"}
              contentBold={"How Bail Bonds Make Freedom Possible"}
            />
            {/* <div className="relative">
            <img src={RoadMapImg1} alt="" />
            <figcaption className="absolute bottom-4 left-2/4  -translate-x-2/4   text-start border border-white bg-white rounded-full py-2  shadow-lg shadow-black/5 saturate-200 ">
              <div className="flex justify-between items-center px-6  ">
                <div>
                  <p className=" font-sans text-xl text-start font-bold  text-black">
                    {"Explore the legal Labyrinth"}
                  </p>

                  <h5 className=" font-sans text-normal antialiased font-semibold leading-snug tracking-normal text-gray-900">
                    {"contentBold"}
                  </h5>
                </div>
                <div>
            ...
            {/* <div className="relative">
            <img src={RoadMapImg1} alt="" />
            <figcaption className="absolute bottom-4 left-2/4  container -translate-x-2/4   text-start border border-white bg-white rounded-full py-2  shadow-lg shadow-black/5 saturate-200 ">
              <div className="flex justify-between items-center px-6  ">
                <div>
                  <p className=" font-sans text-xl text-start font-bold  text-black">
      ...
      <div className="mx-auto py-5 sm:py-6 md:p-6  container px-4 sm:px-6 lg:px-0">
        <ContactForm />
      </div>
      <div className="mx-auto py-5 sm:py-5 md:p-0  container px-4 sm:px-6 lg:px-8">
