      ...
      <div className="flex flex-wrap gap-3">
        <div className="w-full sm:w-72 bg-white rounded-lg overflow-hidden border border-gray-300">
          <div className="px-6 py-4">
            ...
            <p className="text-black-500 text-base mb-2">10’Apr 2023 / 12:00 PM </p>
            <div className="flex flex-col items-center">
              <Link className="mt-4 text-blue-600 text-lg ">Reschedule Meeting</Link>
              <button
                type="button"
        ...
        <div className="w-full sm:w-72 bg-white rounded-lg overflow-hidden border border-gray-300">
          <div className="px-6 py-4">
            <h2 className="text-lg text-gray-500 ">Client Name</h2>
            <p className="text-black-500 text-lg text-base mb-2">Martin Luther king</p>
            <h2 className="text-lg text-gray-500">Legal Matter</h2>
            <p className="text-black-500 text-lg text-base mb-2">Corporate Law</p>{" "}
            <h2 className="text-lg text-gray-500">Phone number</h2>
            <p className="text-black-500 text-lg text-base mb-2">
            +1 - 348-5829-590            </p>{" "}
            <h2 className="text-lg text-gray-500">Appointment Date & Time</h2>
