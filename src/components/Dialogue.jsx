...
export default function Dialogue(props) {
    ...
    const { title, message, btnText, setOpenStatus, openStatus, hideButtons, submitMethod, loading } = props;
    const cancelButtonRef = useRef(null)

    const userid = useSelector(state => state.profile.profileUser.id);
    ...
    return (
        <Transition.Root show={openStatus} as={Fragment}>
            <Dialog as="div" className="relative z-[9999]" initialFocus={cancelButtonRef} onClose={setOpenStatus}>
                <Transition.Child
                    as={Fragment}
